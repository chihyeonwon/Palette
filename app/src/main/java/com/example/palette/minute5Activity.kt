...
class minute5Activity : AppCompatActivity() {
    ...
    private val TAG = minute5Activity::class.java.simpleName
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_minute5)

        tv_minute = findViewById(R.id.tv_minute5)
        tv_second = findViewById(R.id.tv_second5)
